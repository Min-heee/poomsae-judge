...
| H7 | 주춤서기로 볼 **멈춘 구간이 하나도 없음** (양쪽 무릎 ≤ 160° · 발 간격 ≥ 1.2·S · 엉덩이 상하 속도 ≤ 0.06m/s 인 프레임이 없음) | 전체 보류 |
...
사람이 감점 몇 개만 붙은 점수를 받았습니다. 문턱은 가장 좁게 — 주춤서기로 볼 프레임이
하나라도 있으면 채점하고, 그 구간이 짧다는 사실은 A5가 감점으로 말합니다.
...
| 명령 | 결과 |
|---|---|
| `npx vitest run` | **281 passed / 11 files** |
